"""
Test GVA factorization on 90+ bit semiprimes.

This test extends GVA capability from 80-bit to 90+ bit semiprimes,
...
# Generated using primes near 2^45
# p = 35184372088891 (next prime after 2^45)
# q = 35184372088907 (next prime after p)
TEST_CASES_90BIT = [
    {
        'name': '90-bit balanced semiprime',
        'N': 1237940039290094980759032137,
        'p': 35184372088891,
        'q': 35184372088907,
    },
]
...
def test_90bit_gva():
    ...
    """
    print("=" * 70)
    print("GVA Factorization: 90+ Bit Semiprime Test")
    print("=" * 70)
    print()
    
    results = []
    
    for test_case in TEST_CASES_90BIT:
        N = test_case['N']
        ...
        # Test with multiple k values and increased candidates for 90+ bits
