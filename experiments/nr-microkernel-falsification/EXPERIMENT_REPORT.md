...
**Date**: 2025-11-25T13:46:20.642058
...
1. **Runtime penalty is severe**: NR(1) adds 60.5% overhead, NR(2) adds 113.4% overhead—far exceeding the "little speed" cost claimed in the hypothesis.
...
### Runtime
- **NR(1) average overhead**: 60.5%
- **NR(2) average overhead**: 113.4%
...
|-----------|----------|-------|-------|----------------|----------------|------------|------------|
| Gate 1 (30-bit) | ✓ | ✓ | ✓ | 26.8% | 69.8% | 0.00% | 0.00% |
| Gate 2 (60-bit) | ✓ | ✓ | ✓ | 66.3% | 119.2% | 6.92% | 6.92% |
| Verified 50-bit | ✓ | ✓ | ✓ | 74.9% | 134.4% | 0.00% | 0.00% |
| Verified 64-bit | ✓ | ✓ | ✓ | 73.8% | 130.1% | 0.00% | 0.00% |
...
| Excessive overhead (>15%) | ✓ | NR(1): 60.5%, NR(2): 113.4% |
...
The factor search operates on integer candidates. NR is designed for continuous optimization where $x \leftarrow x - f(x)/f'(x)$ produces a real-valued update. In our implementation, we must round NR updates to integers, which:
...
This triples the cost per triggered candidate, explaining the 60-113% overhead observed.
